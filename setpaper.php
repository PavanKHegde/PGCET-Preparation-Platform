...
<form action="upload4.php" method="post" enctype="multipart/form-data">
    <div class="bg-fuchsia-500 pb-4">
<div class="ml-24 ">
     
    <h1 class="text-5xl ml-96  text-white decoration-dashed"><MArquee> SET Exam Question Papers</MArquee></h1></div></div>
        ...
        <div class="col-xs-8 col-xs-offset-2 ml-24">
            <table class="table table-striped table-hover ">
                ...
                <tr>
                    ...
                    <td class="underline text-blue-500 pb-6"><br><a href="uploadset/<?php echo $row['filename']; ?>" target="_blank">View</a></td>
                    <td class="underline  text-blue-500 "><a href="uploadset/<?php echo $row['filename']; ?>" download>Download</td>
                </tr>
                <?php } ?>
                </tbody>
            </table>
