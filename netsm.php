...
<br><br><br><br><br>
    <div class="">
        <h1 class="text-3xl text-center font-bold text-blue-700 py-8">NET Study Materials</h1>
        <div class="ml-72">
    ...
    <a  class=" text-blue-600 text-center pl-96 ml-44 underline" href="https://www.diwakareducationhub.in/2022/01/12/ugc-net-books-pdf/">* https://www.diwakareducationhub.in/2022/01/12/ugc-net-books-pdf/</a>
    <br><br>
    ...
    <a  class="underline text-blue-600 text-center pl-96 ml-44" href="https://www.anujjindal.in/ugc-net-jrf-paper-1-free-material/">* https://www.anujjindal.in/ugc-net-jrf-paper-1-free-material/</a> -->
    </div>
